...
alterUserStatement
    ...
    | ALTER USER (IF EXISTS)? user ACCOUNT (LOCK | UNLOCK)
    ;
...
nonReserved
    : ACCESS | ACCOUNT | ACTIVE | ADVISOR | AFTER | AGGREGATE | APPLY | ASYNC | AUTHORS | AVG | ADMIN | ANTI | AUTHENTICATION | AUTO_INCREMENT | AUTOMATED
