...
public class ExpressionTest extends PlanTestBase {
    ...
    public void testArithmeticCommutative() throws Exception {
        ...
        planFragment = getFragmentPlan(sql);
        assertContains(planFragment, "days_add(8: id_datetime, 2) = '2020-12-21 00:00:00'");
        assertContains(planFragment, "8: id_datetime = '2020-12-19 00:00:00'");

        sql = "select t1a from test_all_type where date_sub(id_datetime, 2) = '2020-12-21'";
        planFragment = getFragmentPlan(sql);
        assertContains(planFragment, "days_sub(8: id_datetime, 2) = '2020-12-21 00:00:00'");
        assertContains(planFragment, "8: id_datetime = '2020-12-23 00:00:00'");
