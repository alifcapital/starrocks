...
public class CnGroupComputeResourceTest {
    ...
    public void testIsAllGroups() {
        ...
        // null is treated as "default", not all-groups
        CnGroupComputeResource nullGroup = CnGroupComputeResource.of(1L, null);
        Assertions.assertFalse(nullGroup.isAllGroups());
        ...
        CnGroupComputeResource defaultGroup = CnGroupComputeResource.of(1L, CnGroupComputeResource.DEFAULT_GROUP_NAME);
    ...
    public void testWarehouseComputeResourceCnGroupNameIsDefault() {
        ...
        Assertions.assertEquals(CnGroupComputeResource.DEFAULT_GROUP_NAME, resource.getCnGroupName());
    }
    ...
    public void testDefaultResourceCnGroupNameIsDefault() {
        ...
        Assertions.assertEquals(CnGroupComputeResource.DEFAULT_GROUP_NAME, defaultResource.getCnGroupName());
    }
