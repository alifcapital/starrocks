 ...
 *
 * <p>Used by {@link FunctionAnalyzer} (canonicalizes the literal in the AST) and
 * by the percentile MV rewrite matcher (compares query-side vs MV-side values).
 */
public final class PercentileCompression {
    ...
    /**
     * Compression of a digest produced by the legacy 1-arg
     * {@code percentile_hash(value)} overload — the storage layout there used
     * {@code TDigest(1000)} via the default ctor.
     */
    public static final long LEGACY_STORAGE = 1000;
