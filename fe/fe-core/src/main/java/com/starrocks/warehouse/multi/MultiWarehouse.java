...
public class MultiWarehouse extends Warehouse {
    ...
    public List<ComputeNode> getNodes() {
        return WarehouseProcDir.getNodes(this);
    }
    ...
    public List<String> getWarehouseInfo() {
        ...
        return Lists.newArrayList(
                ...
                String.valueOf(0L),  // RunningSql is filled from the query snapshot.
                String.valueOf(0L),  // QueuedSql is filled from the query snapshot.
