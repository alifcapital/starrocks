...
public class EditLogDeserializer {
    ...
    private static final ImmutableMap<Short, Class<? extends Writable>> OPTYPE_TO_DESER_CLASS
            ...
            .put(OperationType.OP_ADD_EXTERNAL_MULTI_COLUMN_STATS_META, ExternalMultiColumnStatsMeta.class)
            .put(OperationType.OP_REMOVE_EXTERNAL_MULTI_COLUMN_STATS_META, ExternalMultiColumnStatsMeta.class)
