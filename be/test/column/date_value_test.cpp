...
TEST(DateValueTest, getOffsetByTimezone) {
    {
        ...
        TimezoneOffsetCache tz_cache(ctz);
        auto offset = tz_cache.get_offset_for_timestamp(timestampInDST);
...

    {
        ...
        TimezoneOffsetCache tz_cache(ctz);
        auto offset = tz_cache.get_offset_for_timestamp(timestampOutOfDST);
