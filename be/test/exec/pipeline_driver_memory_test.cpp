...
protected:
    void SetUp() override {
        // Enable explicit TLS trackers for these isolated scheduler callbacks.
        tls_mem_tracker = nullptr;
        _was_global_init = GlobalEnv::_is_init;
        GlobalEnv::_is_init = true;
    ...
    void TearDown() override {
        GlobalEnv::_is_init = _was_global_init;
        tls_mem_tracker = nullptr;
    }
...
TEST_F(PipelineDriverMemoryTest, ObserverFromAnotherFragment) {
    ...
    _fragment_ctx.event_scheduler()->attach_queue(&queue);
