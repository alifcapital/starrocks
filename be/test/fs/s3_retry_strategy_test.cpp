...
protected:
    ...
    static Aws::Client::AWSError<Aws::Client::CoreErrors> make_error(int http_code,
                                                                     Aws::Client::CoreErrors error_type =
                                                                             Aws::Client::CoreErrors::SERVICE_UNAVAILABLE,
...
TEST_F(S3RetryStrategyTest, test_global_throttle_update) {
    ...
    S3RetryStrategy::wait_for_global_throttle();  // Clear any existing throttle
