...
static inline void unpack1to8_uint32(const uint8_t* __restrict__ in, uint32_t* __restrict__ out,
                                      int64_t num_values, int bit_width) {
...
static inline void unpack9to16_uint32(const uint8_t* __restrict__ in, uint32_t* __restrict__ out,
                                       int64_t num_values, int bit_width) {
    const uint32_t mask = kMask[bit_width];
    auto writeEnd = out + num_values;
...
static inline void unpack17to24_uint32(const uint8_t* __restrict__ in, uint32_t* __restrict__ out,
                                        int64_t num_values, int bit_width) {
    const uint32_t mask = kMask[bit_width];
    auto writeEnd = out + num_values;
...
static inline void unpack25to32_uint32(const uint8_t* __restrict__ in, uint32_t* __restrict__ out,
                                        int64_t num_values, int bit_width) {
    const uint32_t mask = kMask[bit_width];
    auto writeEnd = out + num_values;
...
template <>
inline void unpack<uint32_t>(int bit_width, const uint8_t* __restrict__ in, int64_t in_bytes,
                              int64_t num_values, uint32_t* __restrict__ out) {
...
static inline void unpack1to8_uint16(const uint8_t* __restrict__ in, uint16_t* __restrict__ out,
                                      int64_t num_values, int bit_width) {
...
static inline void unpack9to16_uint16(const uint8_t* __restrict__ in, uint16_t* __restrict__ out,
                                       int64_t num_values, int bit_width) {
    const uint16_t mask = static_cast<uint16_t>(kMask[bit_width]);
    auto writeEnd = out + num_values;
...
template <>
inline void unpack<uint16_t>(int bit_width, const uint8_t* __restrict__ in, int64_t in_bytes,
                              int64_t num_values, uint16_t* __restrict__ out) {
...
// Unpack for uint8_t
template <>
inline void unpack<uint8_t>(int bit_width, const uint8_t* __restrict__ in, int64_t in_bytes,
                             int64_t num_values, uint8_t* __restrict__ out) {
...
template <typename T>
inline void unpack(int bit_width, const uint8_t* __restrict__ in, int64_t in_bytes,
                   int64_t num_values, T* __restrict__ out) {
