...
Status HdfsOrcScanner::build_iceberg_delete_builder() {
    ...
    const IcebergDeleteBuilder iceberg_delete_builder(
                                _scanner_params.fs, _scanner_params.path, _scanner_params.conjunct_ctxs,
                                _scanner_params.materialize_slots, &_need_skip_rowids, _scanner_params.datacache_options);
