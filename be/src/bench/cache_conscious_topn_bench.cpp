...
// the live table first exceeds config::cache_conscious_topn_l2_budget_bytes (default 512 KiB); at
// ~16 B per group slot that is ~32k groups. Modeled directly here so the bench mirrors the flip.
