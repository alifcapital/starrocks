...
// Decision-gating bench for the proposal's P1.C: should a direct-array
// variant for low-range INT GROUP BY land, or does the existing
// slice_cx1 rewrite already cover the win?
//
