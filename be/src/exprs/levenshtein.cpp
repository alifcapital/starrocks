...
using LevenshteinScorer =
        szs::levenshtein_distance_utf8<char, szs::linear_gap_costs_t, std::allocator<char>, sz_caps_si_k>;
#else
using LevenshteinScorer =
        szs::levenshtein_distance_utf8<char, szs::linear_gap_costs_t, std::allocator<char>, sz_cap_serial_k>;
#endif
