...
# stringzilla - SIMD string similarity (Levenshtein, etc)
STRINGZILLA_DOWNLOAD="https://github.com/ashvardanian/StringZilla/archive/refs/tags/v4.5.1.tar.gz"
STRINGZILLA_NAME="StringZilla-4.5.1.tar.gz"
STRINGZILLA_SOURCE="StringZilla-4.5.1"
STRINGZILLA_MD5SUM=""
...
TP_ARCHIVES="CLUCENE LIBEVENT OPENSSL THRIFT PROTOBUF GFLAGS GLOG GTEST RAPIDJSON SIMDJSON SNAPPY GPERFTOOLS ZLIB LZ4 BZIP CURL \
            ...
            FIU LIBDEFLATE LLVM ABSL CARES GRPC SIMDUTF TENANN POCO ICU XSIMD LIBXML2 AZURE LIBDIVIDE PPROF FLAMEGRAPH XXHASH STRINGZILLA"
